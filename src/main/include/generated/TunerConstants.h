...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 5.41_mps;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.430908203125_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 12.7285_in;
    static constexpr units::inch_t kFrontLeftYPos = 12.7285_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = 0.301025390625_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 12.7285_in;
    static constexpr units::inch_t kFrontRightYPos = -12.7285_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = -0.301513671875_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -12.7285_in;
    static constexpr units::inch_t kBackLeftYPos = 12.7285_in;

    // Back Right
    static constexpr int kBackRightDriveMotorId = 8;
    static constexpr int kBackRightSteerMotorId = 9;
    static constexpr int kBackRightEncoderId = 7;
    static constexpr units::turn_t kBackRightEncoderOffset = 0.4150390625_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -12.7285_in;
    static constexpr units::inch_t kBackRightYPos = -12.7285_in;
